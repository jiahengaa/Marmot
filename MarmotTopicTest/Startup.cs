...
namespace MarmotTopicTest
{
    public class Startup
    {
        ...
        private void UseValidateForSwagger(SwaggerGenOptions swaggerGenOptions)
        {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerCustom(Configuration, "MarmotTopicTest");//必须在app.UseMvc()之前调用
